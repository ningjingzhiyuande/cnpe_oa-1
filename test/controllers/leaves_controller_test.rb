...
class LeavesControllerTest < ActionController::TestCase
  ...
  test "should create leafe" do
    assert_difference('Leave.count') do
      post :create, leafe: { end_at: @leafe.end_at, image: @leafe.image, info: @leafe.info, kind: @leafe.kind, start_at: @leafe.start_at, status: @leafe.status, user_id: @leafe.user_id }
    end
  ...
  test "should update leafe" do
    patch :update, id: @leafe, leafe: { end_at: @leafe.end_at, image: @leafe.image, info: @leafe.info, kind: @leafe.kind, start_at: @leafe.start_at, status: @leafe.status, user_id: @leafe.user_id }
    assert_redirected_to leafe_path(assigns(:leafe))
  end
